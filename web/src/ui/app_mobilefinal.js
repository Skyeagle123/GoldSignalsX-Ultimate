...
// السعر الحي بيضل من سكربتات GSX اللي جوّا index، هون منركّز على الشموع + المؤشرات + الـ UI.
...
function setSavedBase(v) {
  ...
  // خليه يحدّث السكربتات التانية إذا كانت تستعمل نفس الـ key
...
function calcStoch(bars, kPeriod = 14, dPeriod = 3) {
  ...
  // بسيط: %D = SMA آخر 3 قيم K (بنستعمل نفس K لأننا ما حسبنا التاريخي)
  const d = k;
  return { k, d };
}
